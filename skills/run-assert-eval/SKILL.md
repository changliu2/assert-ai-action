...
> Provenance: vendored verbatim from responsibleai/ASSERT (https://raw.githubusercontent.com/responsibleai/ASSERT/main/.claude/skills/run-assert-eval/SKILL.md).
